/**
 * INF 421 DM2 extended tests. This file is provided for your benefit only.
 * This test concerns Part 2 - standard option.
...
class Test2 {
    ...
    public static void main(String[] args) {
        ...
        test3(getRandomString(1000),getRandomString(1000));
        test3(getRandomString(10000),getRandomString(100));
        test3(getRandomString(100),getRandomString(10000));
